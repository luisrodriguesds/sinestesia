...
<div class="row">
	<div class="col-md-6 center-block p">
		...
		<form method="post">
			...
			<div class="form-group">
				<label for="casoSup">Se você assinalou formação em nível superior, nos informe o seu Curso e em que semestre você está</label>
			...
			<div class="form-group">
				<label for="quest3">Você usou hoje alguma droga ou remédio que afete o seu Sistema Nervoso?</label>
			...
			<div class="form-group text-right">
				<input type="submit" class="btn btn btn-special" name="continuar" value="Salvar e continuar">
			</div>
		</form>
	</div>
</div>